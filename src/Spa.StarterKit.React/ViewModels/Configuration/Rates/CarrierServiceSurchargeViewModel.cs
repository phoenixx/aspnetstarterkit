...
{
    [Validator(typeof(CarrierServiceSurchargeValidator))]
    public class CarrierServiceSurchargeViewModel
    {
        public string ServiceType => "CarrierService";
        ...
        public CarrierServiceSurchargeModelViewModel CarrierServiceSurchargeModel { get; set; }
