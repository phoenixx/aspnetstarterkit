...
{
    public class CarrierServiceZoneSurchargeValidator : CarrierServiceSurchargeValidator<CarrierServiceZoneSurchargeViewModel>
    {
        public CarrierServiceZoneSurchargeValidator()
        {
